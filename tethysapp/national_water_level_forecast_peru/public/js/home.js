...
function get_hydrographs (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationcat, stationstatus, stationname, startdate) {
...
//                $('#obsdates').removeClass('hidden');
                ...
                get_dailyAverages (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname);
        		get_monthlyAverages (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname);
        		get_scatterPlot (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname);
        		get_scatterPlotLogScale (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname);
        		makeDefaultTable(watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname, startdate);
...
function get_dailyAverages (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname) {
...
function get_monthlyAverages (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname) {
...
function get_scatterPlot (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname) {
...
function get_scatterPlotLogScale (watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname) {
...
function makeDefaultTable(watershed, subbasin, streamcomid, stationcode, oldstationcode, stationname){
...
function get_time_series_bc(watershed, subbasin, streamcomid, stationcode, oldstationcode, stationcat, stationstatus, stationname, startdate) {
    $('#forecast-bc-loading').removeClass('hidden');
    $('#forecast-bc-chart').addClass('hidden');
    $('#dates').addClass('hidden');
    $.ajax({
